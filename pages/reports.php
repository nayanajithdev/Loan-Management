...
<section class="panel">
    ...
    <form method="get" class="form-grid">
        ...
        <div class="field">
            <label class="sr-only">Search reports</label>
            <div class="search-control">
                <input type="text" name="q" value="<?= e($search) ?>" placeholder="Search..." aria-label="Search by loan, customer, or phone">
                <button type="submit" class="btn search-submit" aria-label="Search reports">
